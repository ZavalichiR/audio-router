...
class BotProcess:
    ...
    def __init__(self, bot_id: str, bot_type: str, token: str, channel_id: int, 
                 guild_id: int, process: subprocess.Popen = None):
        """
    ...
    def start(self) -> bool:
        ...
        try:
            ...
            logger.info(f"Started {self.bot_type} bot process {self.bot_id} (PID: {self.pid})")
            return True
...
class ProcessManager:
    ...
    async def start_listener_bot(self, channel_id: int, guild_id: int, speaker_channel_id: int = None) -> Optional[str]:
        """
    ...
    async def stop_bots_by_guild(self, guild_id: int) -> bool:
        ...
        try:
            success = True
            bot_ids = [
                bot_id for bot_id, bot_process in self.bot_processes.items()
