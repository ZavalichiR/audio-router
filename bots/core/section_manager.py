...
class SectionManager:
    ...
    def __init__(
        self, process_manager: ProcessManager, access_control: AccessControl = None
    ):
        """
            ...
            if not permission_setup_success:
                try:
                    ...
                    if guild.me.guild_permissions.manage_channels:
                        ...
                        logger.warning(
                            f"Bot lacks 'Manage Channels' permission - control channel will remain public"
                        )
    ...
    async def create_broadcast_section(
        ...
        try:
            ...
            category = await guild.create_category(
                name=section_name, reason=f"Creating broadcast section: {section_name}"
            )
