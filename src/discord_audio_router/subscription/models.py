...
SUBSCRIPTION_TIERS = {
    SubscriptionTier.FREE: {"name": "Free", "max_listeners": 1},
    SubscriptionTier.BASIC: {"name": "Basic", "max_listeners": 2},
    SubscriptionTier.STANDARD: {"name": "Standard", "max_listeners": 6},
    SubscriptionTier.ADVANCED: {"name": "Advanced", "max_listeners": 12},
    SubscriptionTier.PREMIUM: {"name": "Premium", "max_listeners": 24},
